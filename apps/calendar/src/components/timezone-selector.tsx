...
export function TimezoneSelector({ value, onValueChange, placeholder = "Select your timezone...", className, timeFormat = '24_hour' }: TimezoneSelectorProps) {
  ...
  const timezonesByRegion = allTimezones.reduce((acc, tz) => {
