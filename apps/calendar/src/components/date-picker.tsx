...
interface CalendarItemProps {
  ...
  onDateSelect: (date: Date | Date[] | DateRange | undefined, selectedDate: Date | undefined, activeModifiers: Modifiers, e: React.MouseEvent | React.KeyboardEvent) => void
}
    ...
    case "multiple":
      return (
        <Calendar
          {...baseProps}
          mode="multiple"
          selected={selection.selected as Date[]}
        />
      )
    case "single":
      return (
    ...
    case "range":
      return (
        <Calendar
          {...baseProps}
          mode="range"
          selected={selection.selected as DateRange}
        />
      )
  }
}
