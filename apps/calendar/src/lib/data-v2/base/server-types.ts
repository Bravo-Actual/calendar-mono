...
export type ServerUserWorkPeriodInsert =
  Database['public']['Tables']['user_work_periods']['Insert'];
export type ServerUserWorkPeriodUpdate =
  Database['public']['Tables']['user_work_periods']['Update'];
