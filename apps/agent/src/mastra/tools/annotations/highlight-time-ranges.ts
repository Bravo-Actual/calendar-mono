...
export const highlightTimeRangesTool = createTool({
  ...
  inputSchema: z.object({
    timeRanges: z
      .array(
        z.object({
          start: z
            .string()
            .describe('ISO timestamp for start of AI highlight (e.g., "2024-01-15T09:00:00.000Z")'),
          end: z
            .string()
            .describe('ISO timestamp for end of AI highlight (e.g., "2024-01-15T10:00:00.000Z")'),
          description: z
            .string()
            .optional()
            .describe(
              "Optional visible label for this time range. Can include any emojis to indicate quality/status (e.g., '⭐⭐⭐ Excellent slot', 'Focus time 🎯', 'Available 🟢', 'Morning energy ☀️', 'Late night 🌙', 'Coffee break ☕'). Text appears directly on the highlight when tall enough, otherwise shows as tooltip."
            ),
        })
      )
    ...
    description: z
      .string()
      .optional()
      .describe('Overall context for why these time ranges are highlighted'),
  }),
