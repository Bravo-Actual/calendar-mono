...
- Remove outdated highlights before adding new ones`,
  inputSchema: z.object({
    ...
    action: z
      .enum(['create', 'read', 'update', 'delete', 'clear'])
      .optional()
      .describe(
        "Single operation mode. Use 'create' to add new highlights, 'read' to query existing ones, 'update' to modify existing highlights, 'delete' to remove specific highlights, 'clear' to remove all or by type"
      ),
    type: z
      .enum(['events', 'time'])
      .optional()
      .describe(
        "Highlight type: 'events' for yellow overlays on specific calendar events, 'time' for colored blocks on time ranges"
      ),
    ...
    eventIds: z
      ...
      .optional()
      .describe(
        "Array of calendar event IDs to highlight with yellow overlays. Get these from calendar context or getCalendarEvents tool. Use when type='events'"
      ),
    timeRanges: z
      .array(
        z.object({
          ...
          title: z
            .string()
            .optional()
            .describe("Title for this specific time range (e.g. 'Deep Work', 'Break Time')"),
          description: z
            .string()
            .optional()
            .describe('Description explaining why this time is highlighted'),
          emoji: z
            .string()
            .optional()
            .describe("Emoji to represent this time range (e.g. '🎯', '☕', '📞')"),
        })
      )
      .optional()
      .describe("Array of time periods to highlight with colored blocks. Use when type='time'"),
    title: z
      .string()
      .optional()
      .describe(
        "Default title applied to all highlights being created (e.g. 'Important Meetings', 'Focus Blocks')"
      ),
    description: z
      .string()
      .optional()
      .describe('Default description applied to all highlights being created'),
    emoji: z
      .string()
      .optional()
      .describe("Default emoji applied to all highlights being created (e.g. '🔥', '⭐', '⚠️')"),
    ...
    startDate: z
      ...
      .optional()
      .describe(
        'Filter highlights starting from this date (ISO format). Use to find highlights in specific time periods'
      ),
    endDate: z
      .string()
      .optional()
      .describe(
        'Filter highlights until this date (ISO format). Combine with startDate for date range queries'
      ),
    highlightIds: z
      .array(z.string())
      .optional()
      .describe('Specific highlight IDs to retrieve. Use when you know exact highlights to query'),
      ...
      .array(
        z.object({
          ...
          visible: z
            .boolean()
            .optional()
            .describe('Whether highlight should be visible (true) or hidden (false)'),
          startTime: z
            .string()
            .optional()
            .describe('New start time (ISO format) - only for time highlights'),
          endTime: z
            .string()
            .optional()
            .describe('New end time (ISO format) - only for time highlights'),
        })
      )
      .optional()
      .describe('Array of highlight modifications. Each update targets one highlight by ID'),
      ...
      .array(
        z.object({
          action: z
            ...
            .describe(
              'What this operation does: create new highlights, update existing ones, delete specific highlights, or clear by type'
            ),
          type: z
            .enum(['events', 'time'])
            .optional()
            .describe(
              'For create/clear operations: whether to work with event highlights or time highlights'
            ),
          ...
          eventIds: z
            .array(z.string())
            .optional()
            .describe('Event IDs to highlight in this create operation'),
          timeRanges: z
            .array(
              z.object({
                ...
                description: z
                  .string()
                  .optional()
                  .describe('Description for this specific time range'),
                emoji: z.string().optional().describe('Emoji for this specific time range'),
              })
            )
            .optional()
            .describe('Time ranges to highlight in this create operation'),
          title: z
            .string()
            .optional()
            .describe('Default title for all highlights created in this operation'),
          description: z
            .string()
            .optional()
            .describe('Default description for all highlights created in this operation'),
          emoji: z
            .string()
            .optional()
            .describe('Default emoji for all highlights created in this operation'),
          ...
          updates: z
            ...
            .optional()
            .describe('Highlight updates for this update operation'),
          highlightIds: z
            .array(z.string())
            .optional()
            .describe('Highlight IDs to delete in this delete operation'),
        })
      )
      .optional()
      .describe(
        'BATCH MODE: Array of operations executed together. Perfect for complex scenarios like: 1) Delete old highlights, 2) Create new event highlights, 3) Add focus time blocks. Operations execute in sequence.'
      ),
  }),
