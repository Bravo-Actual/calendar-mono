...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      event_details_personal: {
        Row: {
          ...
          time_defense_level: Database['public']['Enums']['time_defense_level'] | null;
    ...
    Views: {
      events_resolved: {
        Row: {
          ...
          join_model: Database['public']['Enums']['event_join_model_types'] | null;
          online_chat_link: string | null;
    ...
    Enums: {
      ...
      user_role: 'viewer' | 'contributor' | 'owner' | 'delegate_full' | 'attendee';
