...
export type UserWorkPeriod = Database['public']['Tables']['user_work_periods']['Row'];
...
export class AppDB extends Dexie {
  ...
  constructor() {
    ...
    this.version(4).stores({ // Increment version for work periods addition
      ...
      user_work_periods: 'id, user_id, weekday, start_time_ms, end_time_ms, updated_at',
